...
namespace Messanger
{
    class MessangerClientAPI
    {
        ...
        {
            WebRequest request = WebRequest.Create("http://localhost:5000/api/Mess/" + MessageId.ToString());
            request.Method = "Get";
        ...
        {
            var responseString = await client.GetStringAsync("http://localhost:5000/api/Mess/" + MessageId.ToString());
        ...
        public Message GetMessageRestSharp(int MessageId)
        {
            ...
            var request = new RestRequest("/api/Mess/" + MessageId.ToString(), Method.GET);
        ...
        public bool SendMessageRestSharp(Message msg)
        {
            string ServiceUrl = "http://localhost:5000";
            var client = new RestClient(ServiceUrl);
            var request = new RestRequest("/api/Mess", Method.POST);
            // Json to post.
        ...
        {
            WebRequest request = WebRequest.Create("http://localhost:5000/api/Mess");
            request.Method = "POST";
